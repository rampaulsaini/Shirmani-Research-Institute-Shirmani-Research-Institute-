...
TRACKED = [
    ...
    "VERIFICATION-QUEUE.json", "VERIFICATION-QUEUE-QC.json",
    "independent-verification-registry.jsonl", "VERIFICATION-REGISTRY.json",
    "VERIFICATION-REGISTRY-QC.json", "VERIFICATION-PROMOTION-QC.json",
    "VERIFICATION-PACKET-QC.json", "PUBLICATION-GATE.json",
    "research-evidence-graph.json", "RESEARCH-EVIDENCE-GRAPH.json",
    "RESEARCH-EVIDENCE-GRAPH-QC.json", "QC-REPORT.json", "worker-status.json",
]
