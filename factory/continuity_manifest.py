...
TRACKED = [
    ...
    "VERIFICATION-QUEUE.json", "VERIFICATION-QUEUE-QC.json", "independent-verification-registry.jsonl", "VERIFICATION-REGISTRY.json", "VERIFICATION-REGISTRY-QC.json", "VERIFICATION-PROMOTION-QC.json", "QC-REPORT.json", "worker-status.json",
]
