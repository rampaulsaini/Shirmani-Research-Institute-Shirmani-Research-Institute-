#!/usr/bin/env python3
"""Deterministic NEXT_LABEL gate for the heart-view framework.

Framework vocabulary is preserved. Phrases such as "मन/बुद्धि निष्क्रिय"
are not converted into physiological claims without independent measurement.
"""
import json
