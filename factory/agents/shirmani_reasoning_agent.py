...
This agent does not prove philosophical claims. It records what can be tested,
what evidence is needed, and where independent review is required.
"""
import hashlib, json
...
def reason(claim, source_ids=None):
    ...
    return {
        ...
        "method_trace":[
            "source_provenance","textual_context","cross-source-comparison",
